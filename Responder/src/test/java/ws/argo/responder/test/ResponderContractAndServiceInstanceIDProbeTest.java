...
public class ResponderContractAndServiceInstanceIDProbeTest extends ResponderProbeTest {
  ...
  @Test
  public void testContractID1JSON() throws UnsupportedPayloadType, IOException, InterruptedException {
  ...
  @Test
  public void testContractID1XML() throws UnsupportedPayloadType, IOException, InterruptedException {
    final String targetContractId = "urn:uuid:dbbc5efa-42e3-418c-a753-d2f3392ada07";
  ...
  @Test
  public void testContractID2JSON() throws UnsupportedPayloadType, IOException, InterruptedException {
  ...
  @Test
  public void testContractID2XML() throws UnsupportedPayloadType, IOException, InterruptedException {
    final String targetContractId = "urn:uuid:4de22333-17ef-4028-b25c-6869ba080c08";
    JsonArray serviceArray = probeForContractID(targetContractId, ProbeWrapper.XML);
  ...
  @Test
  public void testUnknownContractID() throws UnsupportedPayloadType, IOException, InterruptedException {
  ...
  @Test
  public void testServiceInstanceID1JSON() throws UnsupportedPayloadType, IOException, InterruptedException {
  ...
  @Test
  public void testServiceInstanceID1XML() throws UnsupportedPayloadType, IOException, InterruptedException {
    final String targetServiceInstanceId = "urn:uuid:87362eb4-043b-4c75-b7e3-73462a7e9fce";
  ...
  @Test
  public void testServiceInstanceID2JSON() throws UnsupportedPayloadType, IOException, InterruptedException {
  ...
  @Test
  public void testServiceInstanceID2XML() throws UnsupportedPayloadType, IOException, InterruptedException {
    final String targetServiceInstanceId = "urn:uuid:bd61b54b-93d1-4c9a-81b7-c189c383f459";
    JsonArray serviceArray = probeForServiceInstanceID(targetServiceInstanceId, ProbeWrapper.XML);
  ...
  private JsonArray probeForContractID(String targetContractId, String payloadType) throws UnsupportedPayloadType, IOException, InterruptedException {
  ...
  private JsonArray probeForServiceInstanceID(String targetServiceInstanceId, String payloadType) throws UnsupportedPayloadType, IOException, InterruptedException {
    Probe probe = new Probe(payloadType);
    probe.addRespondToURL("", "http://localhost:9998/listener/probeResponse");
  ...
  private JsonArray sendProbe(Probe probe) throws IOException, InterruptedException {
    gen.sendProbe(probe);
