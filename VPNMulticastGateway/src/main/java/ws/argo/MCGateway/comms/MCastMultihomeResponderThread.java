...
//			System.out.println("Listening for packet on interface "+this.ni.getName()+":"+this.ni.getDisplayName()+":"+nicAddrDisplayString());
			try {
				socket.receive(packet);
//				System.out.println("Received packet on interface "+this.ni.getName()+":"+this.ni.getDisplayName());				
				// Get the string
